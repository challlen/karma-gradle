...
To build and test the plugin on mavenLocal, at this plugin's folder, type
...
Note: The artifactId must temporarily be set to com.challlen.karma.gradle.plugin to validate on mavenLocal.
